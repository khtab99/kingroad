...
import { Loader2, MapPin, Phone, Mail, User, CreditCard, Package } from 'lucide-react';
...
export default function GuestCheckoutForm({ cartItems, cartTotal }: GuestCheckoutFormProps) {
  ...
  const onSubmit = async (data: GuestOrderData) => {
    ...
    try {
      ...
      if (response.status === 1) {
        ...
        router.push(`/checkout/success?order=${response.data.order_number}&phone=${data.customer_phone}`);
      } else {
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <Label htmlFor="additional_description">Additional Description</Label>
                  <Textarea
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-gray-600 ml-6">Pay when your order is delivered</p>
                </div>
              </CardContent>
            </Card>
                ...
                {cartItems.map((item) => (
                  <div key={item.id} className="flex items-center space-x-3">
                    <div className="relative">
                      <img
                        src={item.product.featured_image || '/assets/images/product/placeholder.jpg'}
