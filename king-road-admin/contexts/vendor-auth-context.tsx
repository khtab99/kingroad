...
export function VendorAuthProvider({
  ...
  useEffect(() => {
    const savedUser = localStorage.getItem("kingroad-vendor-user");
    const savedToken = localStorage.getItem("kingroad-vendor-token");
    ...
    if (savedUser && savedToken) {
      try {
        ...
        localStorage.removeItem("kingroad-vendor-user");
        localStorage.removeItem("kingroad-vendor-token");
      }
    }
    setIsLoading(false);
  }, []);
  ...
  const login = async (email: string, password: string): Promise<boolean> => {
    ...
    try {
      ...
      setUser(mockUser);
      localStorage.setItem("kingroad-vendor-user", JSON.stringify(mockUser));
      localStorage.setItem("kingroad-vendor-token", mockToken);
